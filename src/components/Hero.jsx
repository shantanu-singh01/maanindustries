  ...
  return (
    <div className="hero">
      ...
      <div className="hero-right">
        <p><span style={{color:"#000", fontWeight:"600", fontSize:"22px"}}>Maan Industries</span> formerly known as DMaan Polymer  is a leading plastic manufacturing company specializing in the production of high-quality Color, Black, Specialty, Filler, and other additive Masterbatches.</p>
